...
<body >
<img class="bg" src="image/background2.jpg" alt="">
<nav>
           <a href="index.html" ><img src="image/home.png" class="logo"></a>
    ...
    <div class="comment-box">
        <h2>
            ...
            <?php
        if($insert == true){
        echo "<p class='submitMsg'>Tank you for submit your review</p>";
        }
    ?>
        </h2>
